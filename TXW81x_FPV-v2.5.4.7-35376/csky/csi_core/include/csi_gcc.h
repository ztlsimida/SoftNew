...
/**
  ...
  Can only be executed in Privileged modes.
 */
__ALWAYS_STATIC_INLINE uint32_t __in_disable_irq(uint32_t psr)
{
    return !(psr & 0x40);
}
...
__ALWAYS_STATIC_INLINE uint32_t __get_Int_SP(void)
{
    ...
    __ASM volatile("mfcr %0, cr<15, 1>" : "=r"(result) : : "memory");
    return (result);
}
...
__ALWAYS_STATIC_INLINE uint32_t __get_VBR(void)
{
    ...
    __ASM volatile("mfcr %0, vbr" : "=r"(result) : : "memory");
    return (result);
}
...
__ALWAYS_STATIC_INLINE uint32_t __get_EPC(void)
{
    ...
    __ASM volatile("mfcr %0, epc" : "=r"(result) : : "memory");
    return (result);
}
...
{
    __ASM volatile("mtcr %0, epc" : : "r"(epc) : "memory");
}
...
__ALWAYS_STATIC_INLINE uint32_t __get_EPSR(void)
{
    ...
    __ASM volatile("mfcr %0, epsr" : "=r"(result) : : "memory");
    return (result);
}
...
{
    __ASM volatile("mtcr %0, epsr" : : "r"(epsr) : "memory");
}
...
#ifdef __CK610
    __ASM volatile("mfcr %0, cr13" : "=r"(result) : : "memory");
#else
    __ASM volatile("mfcr %0, cr<13, 0>" : "=r"(result) : : "memory");
#endif
    return (result);
}
...
__ALWAYS_STATIC_INLINE uint32_t __get_DCSR(void)
{
    uint32_t result;
#ifdef __CK610
    __ASM volatile("mfcr %0, cr14" : "=r"(result) : : "memory");
#else
    __ASM volatile("mfcr %0, cr<14, 0>" : "=r"(result) : : "memory");
#endif
    return (result);
}
...
{
#ifdef __CK610
    __ASM volatile("mtcr %0, cr14" : : "r"(dcsr) : "memory");
#else
    __ASM volatile("mtcr %0, cr<14, 0>" : : "r"(dcsr) : "memory");
#endif
}
...
__ALWAYS_STATIC_INLINE uint32_t __get_CFR(void)
{
    uint32_t result;
#ifdef __CK610
    __ASM volatile("mfcr %0, cr17" : "=r"(result) : : "memory");
#else
    __ASM volatile("mfcr %0, cr<17, 0>" : "=r"(result) : : "memory");
#endif
...
{
#ifdef __CK610
    __ASM volatile("mtcr %0, cr17" : : "r"(cfr) : "memory");
#else
    __ASM volatile("mtcr %0, cr<17, 0>" : : "r"(cfr) : "memory");
#endif
}
...
__ALWAYS_STATIC_INLINE uint32_t __get_CIR(void)
{
    uint32_t result;
#ifdef __CK610
    __ASM volatile("mfcr %0, cr22" : "=r"(result) : : "memory");
#else
    __ASM volatile("mfcr %0, cr<22, 0>" : "=r"(result) : : "memory");
#endif
    return (result);
}
...
{
#ifdef __CK610
    __ASM volatile("mtcr %0, cr22" : : "r"(cir) : "memory");
#else
    __ASM volatile("mtcr %0, cr<22, 0>" : : "r"(cir) : "memory");
#endif
}
...
#ifdef __CK610
    __ASM volatile("mfcr %0, cr20" : "=r"(result) : : "memory");
#else
    __ASM volatile("mfcr %0, cr<20, 0>" : "=r"(result) : : "memory");
#endif
    return (result);
}
...
#ifdef __CK610
    __ASM volatile("mfcr %0, cr21" : "=r"(result) : : "memory");
#else
    __ASM volatile("mfcr %0, cr<21, 0>" : "=r"(result) : : "memory");
#endif
    return (result);
}
...
__ALWAYS_STATIC_INLINE uint32_t __get_UR14(void)
{
    ...
    __ASM volatile("mov %0, sp" : "=r"(result) : : "memory");
#else
    __ASM volatile("mfcr %0, cr<14, 1>" : "=r"(result) : : "memory");
#endif
    return (result);
}
...
__ALWAYS_STATIC_INLINE uint32_t __get_HINT(void)
{
    uint32_t result;
#ifdef __CK610
    __ASM volatile("mfcr %0, cr<30, 0>" : "=r"(result) : : "memory");
#else
    __ASM volatile("mfcr %0, cr<31, 0>" : "=r"(result) : : "memory");
#endif
    return (result);
}
...
{
#ifdef __CK610
    __ASM volatile("mtcr %0, cr<30, 0>" : "=r"(hint) : : "memory");
#else
    __ASM volatile("mtcr %0, cr<31, 0>" : : "r"(hint) : "memory");
#endif
}
...
__ALWAYS_STATIC_INLINE uint32_t __get_MIR(void)
{
    ...
    __ASM volatile("cprcr %0, cpcr0" : "=r"(result) : : "memory");
#else
    __ASM volatile("mfcr %0, cr<0, 15>" : "=r"(result) : : "memory");
#endif
    return (result);
}
...
#ifdef __CK610
    __ASM volatile("cpseti 15");
    __ASM volatile("cpwcr %0, cpcr0" : : "r"(mir) : "memory");
#else
    __ASM volatile("mtcr %0, cr<0, 15>" : : "r"(mir) : "memory");
#endif
}
...
#ifdef __CK610
    __ASM volatile("cpseti 15");
    __ASM volatile("cprcr %0, cpcr2" : "=r"(result) : : "memory");
#else
    __ASM volatile("mfcr %0, cr<2, 15>" : "=r"(result) : : "memory");
#endif
    return (result);
}
...
#ifdef __CK610
    __ASM volatile("cpseti 15");
    __ASM volatile("cpwcr %0, cpcr2" : : "r"(mel0) : "memory");
#else
    __ASM volatile("mtcr %0, cr<2, 15>" : : "r"(mel0) : "memory");
#endif
}
...
#ifdef __CK610
    __ASM volatile("cpseti 15");
    __ASM volatile("cprcr %0, cpcr3" : "=r"(result) : : "memory");
#else
    __ASM volatile("mfcr %0, cr<3, 15>" : "=r"(result) : : "memory");
#endif
    return (result);
}
...
#ifdef __CK610
    __ASM volatile("cpseti 15");
    __ASM volatile("cpwcr %0, cpcr3" : : "r"(mel1) : "memory");
#else
    __ASM volatile("mtcr %0, cr<3, 15>" : : "r"(mel1) : "memory");
#endif
}
...
#ifdef __CK610
    __ASM volatile("cpseti 15");
    __ASM volatile("cprcr %0, cpcr4" : "=r"(result) : : "memory");
#else
    __ASM volatile("mfcr %0, cr<4, 15>" : "=r"(result) : : "memory");
#endif
    return (result);
}
...
#ifdef __CK610
    __ASM volatile("cpseti 15");
    __ASM volatile("cpwcr %0, cpcr4" : : "b"(meh) : "memory");
#else
    __ASM volatile("mtcr %0, cr<4, 15>" : : "r"(meh) : "memory");
#endif
}
...
#ifdef __CK610
    __ASM volatile("cpseti 15");
    __ASM volatile("cprcr %0, cpcr6" : "=r"(result) : : "memory");
#else
    __ASM volatile("mfcr %0, cr<6, 15>" : "=r"(result) : : "memory");
#endif
    return (result);
}
...
#ifdef __CK610
    __ASM volatile("cpseti 15");
    __ASM volatile("cpwcr %0, cpcr6" : : "r"(mpr) : "memory");
#else
    __ASM volatile("mtcr %0, cr<6, 15>" : : "r"(mpr) : "memory");
#endif
}
...
#ifdef __CK610
    __ASM volatile("cpseti 15");
    __ASM volatile("cprcr %0, cpcr8" : "=r"(result) : : "memory");
#else
    __ASM volatile("mfcr %0, cr<8, 15>" : "=r"(result) : : "memory");
#endif
    return (result);
}
...
#ifdef __CK610
    __ASM volatile("cpseti 15");
    __ASM volatile("cpwcr %0, cpcr8" : : "r"(mcir) : "memory");
#else
    __ASM volatile("mtcr %0, cr<8, 15>" : : "r"(mcir) : "memory");
#endif
}
...
#ifdef __CK610
    __ASM volatile("cpseti 15");
    __ASM volatile("cprcr %0, cpcr29" : "=r"(result) : : "memory");
#else
    __ASM volatile("mfcr %0, cr<29, 15>" : "=r"(result) : : "memory");
#endif
    return (result);
}
...
#ifdef __CK610
    __ASM volatile("cpseti 15");
    __ASM volatile("cpwcr %0, cpcr29" : : "r"(mpgd) : "memory");
#else
    __ASM volatile("mtcr %0, cr<29, 15>" : : "r"(mpgd) : "memory");
#endif
}
...
#ifdef __CK610
    __ASM volatile("cpseti 15");
    __ASM volatile("cprcr %0, cpcr30" : "=r"(result) : : "memory");
#else
    __ASM volatile("mfcr %0, cr<30, 15>" : "=r"(result) : : "memory");
#endif
    return (result);
}
...
#ifdef __CK610
    __ASM volatile("cpseti 15");
    __ASM volatile("cpwcr %0, cpcr30" : : "r"(msa0) : "memory");
#else
    __ASM volatile("mtcr %0, cr<30, 15>" : : "r"(msa0) : "memory");
#endif
}
...
#ifdef __CK610
    __ASM volatile("cpseti 15");
    __ASM volatile("cprcr %0, cpcr31" : "=r"(result) : : "memory");
#else
    __ASM volatile("mfcr %0, cr<31, 15>" : "=r"(result) : : "memory");
#endif
    return (result);
}
...
#ifdef __CK610
    __ASM volatile("cpseti 15");
    __ASM volatile("cpwcr %0, cpcr31" : : "r"(msa1) : "memory");
#else
    __ASM volatile("mtcr %0, cr<31, 15>" : : "r"(msa1) : "memory");
#endif
}
...
#ifdef __CK610
    __ASM volatile("mfcr %0, cr12" : "=r"(result) : : "memory");
#else
    __ASM volatile("mfcr %0, cr<12, 0>" : "=r"(result) : : "memory");
#endif
    return (result);
}
...
#ifdef __CK610
    __ASM volatile("mfcr %0, cr11" : "=r"(result) : : "memory");
#else
    __ASM volatile("mfcr %0, cr<11, 0>" : "=r"(result) : : "memory");
#endif
    return (result);
}
...
{
#ifdef __CK610
    __ASM volatile("mtcr %0, cr11" : : "r"(gcr) : "memory");
#else
    __ASM volatile("mtcr %0, cr<11, 0>" : : "r"(gcr) : "memory");
#endif
}
...
__ALWAYS_STATIC_INLINE uint32_t __get_WSSR(void)
{
    ...
    __ASM volatile("mfcr %0, cr<0, 3>" : "=r"(result) : : "memory");
    return (result);
}
...
__ALWAYS_STATIC_INLINE uint32_t __get_WRCR(void)
{
    ...
    __ASM volatile("mfcr %0, cr<1, 3>" : "=r"(result) : : "memory");
    return (result);
}
...
{
    __ASM volatile("mtcr %0, cr<1, 3>" : : "r"(wrcr) : "memory");
}
...
__ALWAYS_STATIC_INLINE uint32_t __get_DCR(void)
{
    ...
    __ASM volatile("mfcr %0, cr<8, 3>" : "=r"(result) : : "memory");
    return (result);
}
...
{
    __ASM volatile("mtcr %0, cr<8, 3>" : : "r"(dcr) : "memory");
}
...
__ALWAYS_STATIC_INLINE uint32_t __get_PCR(void)
{
    ...
    __ASM volatile("mfcr %0, cr<9, 3>" : "=r"(result) : : "memory");
    return (result);
}
...
{
    __ASM volatile("mtcr %0, cr<9, 3>" : : "r"(pcr) : "memory");
}
...
__ALWAYS_STATIC_INLINE uint32_t __get_EBR(void)
{
    ...
    __ASM volatile("mfcr %0, cr<1, 1>" : "=r"(result) : : "memory");
    return (result);
}
...
{
    __ASM volatile("mtcr %0, cr<1, 1>" : : "r"(ebr) : "memory");
}
...
__ALWAYS_STATIC_INLINE uint32_t __FF0(uint32_t value)
{
    ...
    __ASM volatile("ff0 %0, %1" : "=r"(ret) : "r"(value) : "memory");
    return ret;
}
#endif
...
__ALWAYS_STATIC_INLINE uint32_t __FF1(uint32_t value)
{
    uint32_t ret;
#if !defined (__CK610)
    __ASM volatile("ff1 %0, %1" : "=r"(ret) : "r"(value) : "memory");
#else
    ret = value;
    __ASM volatile("ff1 %0" : "=r"(ret):: "memory");
#endif
    return ret;
}
#endif
...
__ALWAYS_STATIC_INLINE uint32_t __REV16(uint32_t value)
{
    uint32_t result;
#if (__CK80X >= 2)
    __ASM volatile("revh %0, %1" : __CSI_GCC_OUT_REG(result) : __CSI_GCC_USE_REG(value) : "memory");
#else
...
#if (__CK80X >= 0x03U)
    __ASM volatile("brev %0, %1" : "=r"(result) : "r"(value) : "memory");
#else
...
__ALWAYS_STATIC_INLINE uint8_t __LDRBT(volatile uint8_t *addr)
{
    uint32_t result;
//#warning "__LDRBT"
    __ASM volatile("ldb %0, (%1, 0)" : "=r"(result) : "r"(addr) : "memory");
...
//#warning "__LDRHT"
    __ASM volatile("ldh %0, (%1, 0)" : "=r"(result) : "r"(addr) : "memory");
...
//#warning "__LDRT"
    __ASM volatile("ldw %0, (%1, 0)" : "=r"(result) : "r"(addr) : "memory");
    return (result);
}
...
{
//#warning "__STRBT"
    __ASM volatile("stb %1, (%0, 0)" :: "r"(addr), "r"((uint32_t)value));
}
...
{
//#warning "__STRHT"
    __ASM volatile("sth %1, (%0, 0)" :: "r"(addr), "r"((uint32_t)value));
}
...
{
//#warning "__STRT"
    __ASM volatile("stw %1, (%0, 0)" :: "r"(addr), "r"(value));
}
